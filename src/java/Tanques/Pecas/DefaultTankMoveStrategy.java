...
public class DefaultTankMoveStrategy implements MoveStrategy {
    ...
    public DefaultTankMoveStrategy() {
    ...
    public boolean move(Piece peca, int newRow, int newColumn, Board board) {
        ...
        if (isInContaminatedArea(newRow, newColumn) && !piece.getTankType().equals("COMANDANTE")) {
            System.out.println("Somente tanques comandante podem se mover para ou através da área contaminada.");
            return false;
        }
